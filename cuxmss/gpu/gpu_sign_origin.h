...
int gpu_xmss_sign_origin(u8 *sk, u8 *sm, u64 *smlen,
			 const u8 *m, u64 mlen);
int gpu_xmssmt_sign_origin(u8 *sk, u8 *sm, u64 *smlen,
			   const u8 *m, u64 mlen);
...
int gpu_xmss_ip_sign_origin(u8 *sk, u8 *sm, u64 *smlen,
			    const u8 *m, u64 mlen);
int gpu_xmssmt_ip_sign_origin(u8 *sk, u8 *sm, u64 *smlen,
			      const u8 *m, u64 mlen);
